...
CUDA_VISIBLE_DEVICES=7,6,5,4,3,2,1,0 python ./scripts/action-recognition/train_recognizer.py \
    ...
    --val-list /home/ubuntu/data/kinetics400/kinetics400_val_list_rawframes_full.txt \
    --mode hybrid \
    --dtype float32 \
    --prefetch-ratio 1.0 \
    --input-5d \
    --model i3d_resnet101_v1_kinetics400 \
    --num-classes 400 \
    --batch-size 8 \
    --num-gpus 8 \
    --num-data-workers 32 \
    ...
    --clip-grad 40 \
    --log-interval 20 \
    --logging-file i3d_resnet101_v1_kinetics400.log \
    --save-dir ./logs/i3d_resnet101_v1_kinetics400 \
