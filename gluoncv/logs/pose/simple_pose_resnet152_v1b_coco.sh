python train_simple_pose.py \
    --model simple_pose_resnet152_v1b --mode hybrid --num-joints 17 \
    ...
    --save-dir params_simple_pose_resnet152_v1b \
    --logging-file simple_pose_resnet152_v1b_coco.log --log-interval 100
