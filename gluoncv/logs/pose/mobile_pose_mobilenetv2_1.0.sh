python3 train_simple_pose.py \
    --model mobile_pose_mobilenetv2_1.0 --mode hybrid --num-joints 17 \
    ...
    --save-dir params_mobile_pose_mobilenetv2_1.0 \
    --logging-file mobile_pose_mobilenetv2_1.0.log --log-interval 100
