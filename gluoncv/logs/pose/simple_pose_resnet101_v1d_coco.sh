python train_simple_pose.py \
    --model simple_pose_resnet101_v1d --mode hybrid --num-joints 17 \
    ...
    --save-dir params_simple_pose_resnet101_v1d \
    --logging-file simple_pose_resnet101_v1d_coco.log --log-interval 100
