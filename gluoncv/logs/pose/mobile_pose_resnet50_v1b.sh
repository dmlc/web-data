python3 train_simple_pose.py \
    --model mobile_pose_resnet50_v1b --mode hybrid --num-joints 17 \
    ...
    --save-dir params_mobile_pose_resnet50_v1b \
    --logging-file mobile_pose_resnet50_v1b.log --log-interval 100
