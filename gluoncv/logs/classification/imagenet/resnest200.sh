...
--model resnest200 --lr 0.0125 --num-epochs 270 --batch-size 32  \
--use-rec --dtype float32 --warmup-epochs 5 --last-gamma --no-wd \
--label-smoothing --mixup   --save-dir params_resnest200  \
--log-interval 100 --eval-frequency 5 --auto_aug --input-size 256
